...
@section('meta_description', 'Jim Corbett Wedding Package Block Date')
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Package Block Date</h1>
            <div class="row" style="float: right;">
                <div class="col-sm-12">
                    <a href="{{ route('packageblockdates.add.view.index') }}" class=" btn btn-success mt-4">Add Package
                        Block Date</a>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group d-flex gap-2 align-items-center justify-content-center"
                                            ...
                                            <form action="{{ route('packageblockdates.delete', $feature['id']) }}"
                                                method="POST">
                                                @method('DELETE')
                                                @csrf
