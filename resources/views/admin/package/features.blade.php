...
@section('meta_description', 'Jim Corbett Wedding Features List')
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="row" style="float: right;">
                <div class="col-sm-12">
                    <a href="{{ route('feature.add.view.index') }}" class=" btn btn-success mt-4">Add Feature</a>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            @foreach ($features as $feature)
                                <tr>
                                    ...
                                    <td><img src="{{ '/admin/uploads/package-feature/' . $feature['image'] }}" width="70px"
                                            height="70px" /></td>
                                    <td>
                                        <div class="btn-group d-flex gap-2 align-items-center justify-content-center"
                                            role="group">
                                            <a href="{{ route('features.edit.view', $feature['id']) }}" class="editbutton">
