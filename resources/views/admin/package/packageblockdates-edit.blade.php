...
@section('meta_description', 'Jim Corbett Wedding Edit Package Block Date')
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Edit Package Block Date</h1>
        </div>

        <form method="post" action="{{ route('packageblockdates.edit', ['id' => $id]) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-sm-3">
