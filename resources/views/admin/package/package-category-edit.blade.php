...
@section('meta_description', 'Jim Corbett Wedding Package Category Edit Page')
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Package Category Edit</h1>
        </div>
        ...
        <form method="POST" action="{{ route('package.category.update', ['category_id' => $category_id]) }}"
            ...
            <div
                class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center pt-3 mt-4 pb-2 mb-3 border-bottom text-danger fw-bold">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control indian_extra_beds" id="indian_adult2"
                        name="indian[0][extra_beds]" value="{{ $package_indian_option[0]['extra_beds'] ?? '' }}">
                    @error('indian_adult2')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control indian_extra_bed_ch" id="indian_adult3"
                        name="indian[0][extra_bed_ch]" value="{{ $package_indian_option[0]['extra_bed_ch'] ?? '' }}">
                    @error('indian_adult3')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control indian_fe_extra_bed_ch" id="indian_adult4"
                        name="indian[0][fes_room_price]" value="{{ $package_indian_option[0]['fes_room_price'] ?? '' }}">
                    @error('indian_adult4')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control indian_fe_extra_beds" id="indian_adult5"
                        name="indian[0][fes_ad_price]" value="{{ $package_indian_option[0]['fes_ad_price'] ?? '' }}">
                    @error('indian_adult5')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control indian_extra_fe_bed_ch" id="indian_adult6"
                        name="indian[0][fes_ch_price]" value="{{ $package_indian_option[0]['fes_ch_price'] ?? '' }}">
                    @error('indian_adult6')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control indian_sde_price" id="indian_adult6"
                        name="indian[0][s_de_price]" value="{{ $package_indian_option[0]['s_de_price'] ?? '' }}">
                    @error('indian_adult6')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control indian_swe_price" id="indian_adult6"
                        name="indian[0][s_we_price]" value="{{ $package_indian_option[0]['s_we_price'] ?? '' }}">
                    @error('indian_adult6')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control indian_sfe_price" id="indian_adult6"
                        name="indian[0][s_fe_price]" value="{{ $package_indian_option[0]['s_fe_price'] ?? '' }}">
                    @error('indian_adult6')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control for_calculateRoomPrice" id="foreigner_adult1"
                        name="foreigner[0][price]" value="{{ $package_foreigner_option[0]['price'] ?? '' }}">
                ...
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control for_extra_beds" id="foreigner_adult2"
                        name="foreigner[0][extra_beds]" value="{{ $package_foreigner_option[0]['extra_beds'] ?? '' }}">
                ...
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control for_sde_price" id="foreigner_adult6"
                        name="foreigner[0][s_de_price]" value="{{ $package_foreigner_option[0]['s_de_price'] ?? '' }}">
                    @error('foreigner_adult6')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control for_swe_price" id="foreigner_adult6"
                        name="foreigner[0][s_we_price]" value="{{ $package_foreigner_option[0]['s_we_price'] ?? '' }}">
                    @error('foreigner_adult6')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="text" class="form-control for_sfe_price" id="foreigner_adult6"
                        name="foreigner[0][s_fe_price]" value="{{ $package_foreigner_option[0]['s_fe_price'] ?? '' }}">
                    @error('foreigner_adult6')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
