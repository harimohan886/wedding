...
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">How To Reach Page</h1>
        </div>
        ...
        <form method="post" action="{{ route('page.mangement.reach.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group mt-3">
                ...
                <input type="banner_image_alt" class="form-control" id="banner_image_alt" name="banner_image_alt"
                    placeholder="Banner Image Alt" value="{{ old('banner_image_alt', $reach_page->banner_image_alt) }}">
            ...
            <div class="form-group mt-3">
                ...
                <input type="meta_title" class="form-control" id="meta_title" name="meta_title" placeholder="Meta Title"
                    value="{{ old('meta_title', $reach_page->meta_title) }}">
                @error('meta_title')
                    <code>
                        {{ $message }}
                    </code>
