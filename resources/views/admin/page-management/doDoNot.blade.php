        ...
        <form method="post" action="{{ route('page.mangement.doDoNot.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group mt-3">
                ...
                <input type="banner_image_alt" class="form-control" id="banner_image_alt" name="banner_image_alt"
                    placeholder="Banner Image Alt" value="{{ old('banner_image_alt', $DoDoNot_page->banner_image_alt) }}">
            ...
            <div class="form-group mt-3">
                ...
                <input type="meta_title" class="form-control" id="meta_title" name="meta_title" placeholder="Meta Title"
                    value="{{ old('meta_title', $DoDoNot_page->meta_title) }}">
                @error('meta_title')
                    <code>
                        {{ $message }}
                    </code>
