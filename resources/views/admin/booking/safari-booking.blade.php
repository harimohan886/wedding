...
@section('meta_description', 'Jim Corbett Wedding Safari Booking')
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-3 mb-3">
                        ...
                        <select name="filter_booking_type" id="filter_booking_type" class="form-control">
                            ...
                            <option value="jungle_trail" {{ $filter_booking_type == 'jungle_trail' ? 'selected' : '' }}>
                                Jim Corbett Wedding
                                Jungle Trail</option>
                            <option value="devalia" {{ $filter_booking_type == 'devalia' ? 'selected' : '' }}>Devalia Safari
                            </option>
                            <option value="kankai" {{ $filter_booking_type == 'kankai' ? 'selected' : '' }}>Kankai Temple
                                Safari</option>
                            <option value="girnar" {{ $filter_booking_type == 'girnar' ? 'selected' : '' }}>Girnar Temple
                                Safari</option>
                        </select>
                    </div>
                    ...
                    <div class="d-flex align-items-end gap-3 col-lg-3 mb-3">
