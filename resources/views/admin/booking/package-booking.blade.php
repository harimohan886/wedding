...
@section('meta_description', 'Jim Corbett Wedding Package Booking')
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="top_fields">
            <form method="get" action="{{ route('safari-booking', ['type' => 'package']) }}">
                <div class="row">
                    ...
                    {{-- <div class="col-sm-2">
                    <label for="" class="mb-2">Booking Type</label>
                    <select name="filter_booking_type" id="filter_booking_type" class="form-control">
                        <option value="">--Select Safari Type--</option>
                        <option value="jungle_trail" {{ $filter_booking_type == 'jungle_trail' ? 'selected' : '' }}>Jim Corbett Wedding Jungle Trail</option>
                        <option value="devalia" {{ $filter_booking_type == 'devalia' ? 'selected' : '' }}>Devalia Safari</option>
                        <option value="kankai" {{ $filter_booking_type == 'kankai' ? 'selected' : '' }}>Kankai Temple Safari</option>
                    </select>
                </div> --}}
                    ...
                    <div class="d-flex align-items-end gap-3 col-lg-4 mb-2">
                        ...
                        <a href="{{ route('safari-booking', ['type' => 'package']) }}" class="btn btn-primary">Clear
                            Filter</a>
                    </div>
