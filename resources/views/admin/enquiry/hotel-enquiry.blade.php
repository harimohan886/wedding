...
@section('meta_description', 'Jim Corbett Wedding Booking Hotel Enquiry List')
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Hotel Enquiries</h1>
        </div>
            ...
            <form method="get" action="{{ route('hotel-enquiry-list') }}">
                <div class="row">
                    ...
                    <div class="d-flex align-items-end gap-3 col-lg-3 col-md-3 mb-2 ">
                        ...
                        <a href="{{ route('hotel-enquiry-list') }}" class="btn btn-primary">Clear Filter</a>
                    </div>
