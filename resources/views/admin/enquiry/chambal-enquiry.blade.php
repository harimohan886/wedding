...
@section('title', 'Chambal Enquiry List')
@section('meta_description', 'Chambal Enquiry List')
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Chambal Enquiries</h1>
        </div>
        <div class="top_fields">

            <form method="get" action="{{ route('chambal-enquiry-list') }}">
                <div class="row">
                    ...
                    <div class="d-flex align-items-end gap-3 col-lg-3 col-md-3 mb-2">
                        ...
                        <a href="{{ route('chambal-enquiry-list') }}" class="btn btn-primary">Clear Filter</a>
                    </div>
                </div>
            </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group d-flex align-items-center justify-content-center"
                                            role="group">
                                            <form action="{{ route('chambal.enquiry.delete', $customer['id']) }}"
                                                method="POST">
                                                @method('DELETE')
                                                @csrf
